...
Wiring:
* You can change the pins used for the I2C display and relay control in main.py
* Defaults are:
    * I2C SDA: GPIO21
    * I2C SCL: GPIO22
    * GPIO Out for relay control: GPIO15
